...
const appRouter = t.router({
  getHello: t.procedure.query(() => ({ message: "Welcome to Full-Stack tRPC CRUD App" })),
  ...
  getNote:    t.procedure.input(params).query(({ input }) => findNoteController({ paramsInput: input })),
